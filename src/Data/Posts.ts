...
const Posts = [
  ...
  },
  {
    ...
    content:
      'Nostrud cupidatat veniam Lorem ipsum tempor. Cupidatat eiusmod voluptate veniam tempor consequat mollit.',
  ...
  },
  {
    ...
    timeAgo: 1, // hrs
    content:
      'Enim et excepteur esse cupidatat nulla. Cillum eiusmod ipsum ipsum velit culpa nulla consequat veniam magna. Irure consectetur proident commodo ipsum dolore eiusmod sit consequat do proident. Ea Lorem et quis anim enim excepteur velit.',
    hasImage: true, // hasImage or not
  ...
  },
  {
    ...
    content:
      'Ex velit elit mollit magna sit ullamco consequat sint occaecat occaecat excepteur ex sunt. Consectetur irure duis magna Lorem sit. Non ad ipsum dolor irure sit officia elit aute sit nisi laborum id.',
    hasImage: true, // hasImage or not
  ...
  },
  {
    ...
    content:
      'Ut deserunt nulla tempor incididunt pariatur veniam id consectetur duis reprehenderit sit. Sit ad in laborum voluptate anim Lorem ullamco quis occaecat excepteur sunt do velit qui. Ea officia aliqua sit eu sit. Mollit ipsum sit proident reprehenderit dolor veniam nisi aliquip enim.',
    hasImage: false,
  ...
  },
  {
    ...
    timeAgo: 10, // hrs
    content:
      'Dolore elit sit excepteur pariatur do. Elit ipsum aute duis duis ut. Consectetur aliquip sunt ea aute aute cillum non. Ut adipisicing pariatur sit excepteur.',
    hasImage: false,
  ...
  },
  {
    ...
    name: 'Amelia',
    title: 'SDE-1 @Meta || AIML',
    timeAgo: 12, // hrs
    content:
      'Aute laborum duis sint ex enim dolor dolore minim. Nulla laborum duis voluptate nostrud dolore ipsum reprehenderit laboris duis aliqua id esse in cillum. Non culpa id consequat commodo non est fugiat occaecat sunt sint sit ipsum. Consequat nisi ipsum ut officia et cillum cupidatat dolore. Et ex nulla et laborum veniam eiusmod incididunt et sint Lorem in culpa.',
    hasImage: true, // hasImage or not
  ...
  },
  {
    ...
    connection: '1st', // which connection it is - 1st, 2nd, 3rd
    content:
      'Sint consequat fugiat elit magna deserunt sit ut et dolor aute adipisicing elit occaecat qui. Sint labore quis sint veniam id adipisicing commodo nulla non nisi fugiat consectetur officia proident. Nisi mollit nostrud nostrud ut sit anim aute Lorem.',
    hasImage: false,
