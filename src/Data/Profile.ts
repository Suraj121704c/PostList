...
const Profile = {
  ...
  ABOUT:
    'Cupidatat mollit non est excepteur ut laborum Lorem fugiat laborum labore et fugiat occaecat labore. Elit ut veniam laborum commodo commodo cupidatat. Aliqua amet consectetur dolore nostrud enim do velit anim officia consectetur. Tempor dolor sunt Lorem quis labore. Aliquip et irure pariatur sint Lorem mollit consectetur consequat proident sint et labore. Voluptate occaecat magna magna culpa. Ut elit anim laboris non excepteur eu irure incididunt.',
  EXPERIENCE: [
    {
  ...
  PROJECTS: [
    {
      ...
      endDate: 'Present',
      description:
        'Exercitation nostrud sunt occaecat in est qui do dolor labore. Enim sunt qui exercitation aliquip aliquip.',
    },
    {
      ...
      description:
        'Sit nulla magna cupidatat eu. Do fugiat Lorem id elit ipsum cillum officia eu.',
    },
  ],
  PEOPLE_VIEWED: [
    {
